package com.LiuQian.week4.Demo;
...
public class JDBCDemoServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        //code like this is bad way --- because change in java code
        ...
        try {
            ...
            System.out.println("init()--> "+con);//ok(java.code) - ok(use config-in web.cml) -- ok - use(@webservlet)
