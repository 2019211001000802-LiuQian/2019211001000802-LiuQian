        ...
        <div class="table-responsive col-sm-10">
            <table class="table table-condensed">
                ...
                <tr>
                    ...
                    <td>order Date</td>
                    <%
                        com.LiuQian.model.Order o=(com.LiuQian.model.Order)pageContext.findAttribute("o");
                        int userId=o.getCustomerId();
                        java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
                        com.LiuQian.dao.UserDao userDao=new com.LiuQian.dao.UserDao();
                    ...
                    <td class="cart_total">
                        <%
                            ...
                            String paymentType=com.LiuQian.model.Payment.findByPaymentId(con,n);
                        %>
